<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="Emlak.WebForm2" %>

<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="assets3/img/favicon.ico">
    ...
    <link href="assets3/css/animate.min.css" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="assets3/css/light-bootstrap-dashboard.css" rel="stylesheet"/>
    ...
    <link href="assets3/css/pe-icon-7-stroke.css" rel="stylesheet" />
...
<div class="wrapper">
    ...
    <div class="main-panel">
       ...
       <!--   Core JS Files   -->
    <script src="assets3/js/jquery-1.10.2.js" type="text/javascript"></script>
	<script src="assets3/js/bootstrap.min.js" type="text/javascript"></script>

	<!--  Checkbox, Radio & Switch Plugins -->
	<script src="assets3/js/bootstrap-checkbox-radio-switch.js"></script>

	<!--  Charts Plugin -->
	<script src="assets3/js/chartist.min.js"></script>

    <!--  Notifications Plugin    -->
    <script src="assets3/js/bootstrap-notify.js"></script>

    <!--  Google Maps Plugin    -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>

    <!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
	<script src="assets3/js/light-bootstrap-dashboard.js"></script>
