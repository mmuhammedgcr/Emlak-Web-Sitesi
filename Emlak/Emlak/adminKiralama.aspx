<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminKiralama.aspx.cs" Inherits="Emlak.adminKiralama" %>
...
<div class="wrapper" >
    ...
    <div class="main-panel"  >
       ...
       <h2 style="text-align:center"><a style="color:maroon">KİRALAMA İŞLEMİ</a></h2>
        ...
        <section id="about" class="section" style="background-color:burlywood; height: 315px;" >
           <div class="col-lg-12">
                ...
                <div class="form-group row">
                    <div class="col-xs-6">
                        <label for="ex1">ALIŞ TARİHİ</label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtTarih" runat="server" ErrorMessage="Boş Geçilmez" ForeColor="Red"></asp:RequiredFieldValidator>
                        <asp:TextBox ID="txtTarih" runat="server" CssClass="form-control" placeholder="Örnek = Murat"></asp:TextBox>
                    </div>
                    <div class="col-xs-6">
                        <label for="ex1">DEPOZİTO</label><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDepozito" ErrorMessage="Boş Geçilmez" ForeColor="Red"></asp:RequiredFieldValidator>
                        <asp:TextBox ID="txtDepozito" runat="server" CssClass="form-control" placeholder="Örnek = 05056809977" TextMode="Number" MaxLength="11"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-xs-6">
                    ...
                    <div class="col-xs-6">
                        <br />
                        <asp:Button ID="btnKirala" runat="server" OnClick="btnKirala_Click" Text="KİRALA" BackColor="#009933" Font-Bold="True" ForeColor="White" Height="40px" Width="90px" />
                    </div>
                </div>
            </div>
